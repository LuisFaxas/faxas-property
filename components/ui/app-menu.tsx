...
const AppMenu = PopoverPrimitive.Root

const AppMenuTrigger = PopoverPrimitive.Trigger

const AppMenuAnchor = PopoverPrimitive.Anchor
...
>(({ className, align = "center", sideOffset = 4, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        "z-modal min-w-[8rem] rounded-md border bg-popover p-1 text-popover-foreground shadow-md outline-none",
...
AppMenuContent.displayName = PopoverPrimitive.Content.displayName
...
AppDropdownMenuSubTrigger.displayName = DropdownMenuPrimitive.SubTrigger.displayName
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-modal min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-lg",
      "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
      "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2",
      "data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
...
AppDropdownMenuSubContent.displayName = DropdownMenuPrimitive.SubContent.displayName
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      sideOffset={sideOffset}
      className={cn(
        "z-modal min-w-[8rem] rounded-md border bg-popover p-1 text-popover-foreground shadow-md",
...
AppDropdownMenuCheckboxItem.displayName = DropdownMenuPrimitive.CheckboxItem.displayName
